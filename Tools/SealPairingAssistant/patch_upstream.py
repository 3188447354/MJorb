...
def patch_main(path: pathlib.Path) -> None:
    ...
    # The Windows system backdrop paints an opaque rectangle behind a transparent viewport.
    # Keep only the DWM corner preference so the eframe alpha channel exposes real corners.
